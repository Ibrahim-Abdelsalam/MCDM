...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        header.setStyleSheet("color: white; font-size: 36pt; font-family: 'Segoe UI'; font-weight: 600;")
        ...
        subtitle = QLabel(f"Bidirectional Evaluation Platform utilizing AHP, Fuzzy AHP, TOPSIS, and VIKOR Solvers ({role_title} Perspective)")
        ...
        card_title.setStyleSheet(f"font-size: 45pt; font-weight: bold; color: {title_color};")
        ...
        self.count_lbl.setStyleSheet("font-weight: bold; font-size: 45pt;")
        metrics.addWidget(self.count_lbl, 0, 1)

        metrics.addWidget(QLabel("Weight Schemes:"), 1, 0)
        self.schemes_lbl = QLabel("0")
        self.schemes_lbl.setStyleSheet("font-weight: bold; font-size: 45pt;")
