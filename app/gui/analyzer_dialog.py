...
class DecisionAnalyzer(QDialog):
    """Dialog to configure and execute AHP, Fuzzy AHP, TOPSIS, and VIKOR evaluations.
    ...
    def __init__(self, role: str, parent: QWidget | None = None) -> None:
        ...
        self.setFixedSize(DIMENSIONS["dialog_width"], DIMENSIONS["dialog_height"] + 250)
    ...
    def _setup_ui(self) -> None:
        ...
        scroll_layout.setContentsMargins(14, 0, 14, 0)
        ...
        role_lbl.setStyleSheet(f"font-size: 24pt; font-weight: bold; color: {accent_color};")
        ...
        self.fuzzy_ahp_chk = QCheckBox("Fuzzy AHP (Triangular Fuzzy Weights)")
        ...
        self.v_warning_lbl.setStyleSheet("color: red; font-size: 13pt;")
    ...
    def start_analysis(self) -> None:
        ...
        if self.ahp_chk.isChecked():
            methods.append("AHP")
        if self.fuzzy_ahp_chk.isChecked():
            methods.append("FUZZY_AHP")
    ...
    def set_ui_enabled(self, enabled: bool) -> None:
        ...
        self.fuzzy_ahp_chk.setEnabled(enabled)
