        ...
        try:
            ...
            for key, result_df in analysis_results.items():
                ...
                if rank_cols and score_cols:
                    ...
                    cols_to_extract = ["ID", score_col, rank_col]
                    col_renames = ["ID", "Score", "Rank"]
                    if "Is_Compromise" in result_df.columns:
                        cols_to_extract.append("Is_Compromise")
                        col_renames.append("Is_Compromise")
                    export_df = result_df[cols_to_extract].copy()
                    export_df.columns = col_renames
