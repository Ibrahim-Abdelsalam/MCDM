...
class RoleCard(QFrame):
    ...
    def __init__(self, role: str, title: str, subtitle: str, color: str, parent: QWidget | None = None):
        ...
        title_lbl.setStyleSheet("font-size: 28pt; font-weight: bold; color: white; background: transparent;")

        sub_lbl = QLabel(subtitle)
        sub_lbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        sub_lbl.setStyleSheet("font-size: 18pt; color: #f0f4f5; background: transparent;")
...
class RoleSelectionWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        central_widget.setStyleSheet(f"background-color: {COLORS['primary_dark']};")
        ...
        header.setStyleSheet("font-size: 36pt; font-weight: bold; color: white; background: transparent;")
        layout.addWidget(header)

        # Subtitle
        subtitle = QLabel("Select your role to continue")
        subtitle.setAlignment(Qt.AlignmentFlag.AlignCenter)
        subtitle.setStyleSheet("font-size: 22pt; color: #ddeaed; background: transparent;")
